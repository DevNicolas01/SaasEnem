...
const styles = {
  ...
  loaderSpin: 'absolute inset-0 rounded-full border-4 border-amber-400 border-t-transparent animate-spin',
  ...
  progressFill: 'h-full bg-gradient-to-r from-amber-400 to-orange-500 transition-all duration-500',
